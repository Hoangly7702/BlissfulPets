...
import { MdDriveFileRenameOutline,MdOutlinePets, MdOutlineEmail } from "react-icons/md";
	...
	return (
		open && (
			<div className="overlay" >
				<div className="modalContainer" style={{margin:"40px"}}>
					...
					<div className="modalInformation">
						...
						<div>
							<label style={{ margin: "10px" }}>Pet Name:</label>
							<div className="items-value">
								<span className="icon-value">
									<MdOutlinePets />
								</span>
